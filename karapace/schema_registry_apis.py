...
class KarapaceSchemaRegistry(KarapaceBase):
    ...
    def send_schema_message(
        self, subject: str, parsed_schema_json: dict, schema_type: str, schema_id: int, version: int, deleted: bool
    ):
    ...
    async def subject_version_delete(self, content_type, *, subject, version):
        ...
        self.send_schema_message(subject, schema.to_json(), schema.schema_type.value, schema_id, version, deleted=True)
